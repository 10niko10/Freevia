...
const Profile = () => {
    ...
    const deleteProfile = async () => {
        ...
        try {
            ...
            // Get username from user object or current profile
            const username = user.username || user.name; // Adjust based on your user object structure
            ...
            event.target.innerHTML = '<span>იშლება...</span>';
            ...
            if (response.ok) {
                ...
                window.location.href = '/pages/SignIn'; // or '/home' or wherever you want to redirect
